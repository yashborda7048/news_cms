                        ...
                        <form action="save-update-post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    $result_1 = mysqli_query($conn, $sql) or die('Query Failed.');
                                    if (mysqli_num_rows($result_1) > 0) {
                                        while ($row_1 = mysqli_fetch_assoc($result_1)) {
                                            ...
                                            ?>
                                            <option <?php echo $selected ?> value="<?php echo $row_1['category_id'] ?>">
                                                <?php echo $row_1['category_name'] ?>
                                            </option>
                                        <?php }
                                    } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <img src="upload/<?php echo $row['post_img']; ?>" style="margin-top: 15px;" height="150px">
