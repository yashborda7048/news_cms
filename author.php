        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $author_id = isset($_GET['author-id']) ? $_GET['author-id'] : '';
                    $sql_2 = "SELECT * FROM user where user_id =  '{$author_id}'";
                    $result = mysqli_query($conn, $sql_2) or die('Query Unsuccessful.');
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<h2 style='text-transform: capitalize;' class='page-heading'>" . $row['username'] . "</h2>";
                        }
                    }
                    ;
                    $limit = 5;
                    ...
                    $sql_1 = "SELECT * FROM post  WHERE post.author = {$author_id}";
